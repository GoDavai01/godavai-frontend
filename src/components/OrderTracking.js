  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-24 pt-3">
      <div className="max-w-md mx-auto px-2 sm:px-4">
        <Card className="border border-emerald-100/70 shadow-sm rounded-3xl">
          <CardContent className="p-4 sm:p-6">
            {/* Title + ETA */}
            <div className="text-center mb-3">
              <h1 className="text-2xl font-black tracking-tight" style={{ color: PRIMARY }}>
                Track Your Order
              </h1>
              ...
              <div className="mt-2 flex items-center justify-center gap-2">
                <ShadBadge className="bg-emerald-50 text-emerald-700 border border-emerald-100 font-bold text-[13px]">
            ...
            <div className="relative bg-emerald-50/70 rounded-2xl px-3 py-3 mb-4 overflow-hidden">
              ...
              <div
                className="absolute left-3 top-1/2 -translate-y-1/2 h-1.5 bg-emerald-600 rounded-full transition-all"
                style={{
                  width:
                    currentStep <= 0 ? "0%" : currentStep === 1 ? "33%" : currentStep === 2 ? "66%" : "100%",
                }}
              />
                    ...
                    <div key={s.label} className="flex flex-col items-center">
                      ...
                      <div
                        className={`mt-1 text-[11px] font-semibold ${
                          i === currentStep ? "text-emerald-800" : active ? "text-emerald-600" : "text-gray-400"
            ...
            {order.status === "out_for_delivery" && (
              <div className="mb-3 rounded-2xl border border-emerald-100 bg-white p-3 flex items-center justify-between shadow-[0_8px_30px_rgb(0,0,0,0.03)]">
                <div className="flex items-center gap-3">
                  <div className="h-14 w-14 rounded-full bg-emerald-50 border border-emerald-100 overflow-hidden grid place-items-center">
                    <img
                  ...
                  <div>
                    <div className="text-[17px] font-extrabold text-emerald-900">
            ...
            {isDelivered && (
              <div className="mt-3 flex items-center justify-center text-center gap-2">
                ...
                <div className="text-emerald-700 font-extrabold">Fastest medicine, happiest you! Get well soon! 💊❤️</div>
              </div>
            )}
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <Stars value={pharmacyRating || 0} onChange={(v) => setPharmacyRating(v)} disabled={ratingSubmitting} />
                    ...
                    <div className="rounded-2xl border border-emerald-100 bg-white p-3 shadow-[0_8px_30px_rgb(0,0,0,0.03)]">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <Stars value={deliveryRating || 0} onChange={(v) => setDeliveryRating(v)} disabled={ratingSubmitting} />
            ...
            <Button
              onClick={() => navigate("/orders")}
              className="w-full mt-4 font-bold text-[16px] rounded-xl"
              style={{ backgroundColor: PRIMARY, color: "#fff" }}
            >
              Back to My Orders
            </Button>
